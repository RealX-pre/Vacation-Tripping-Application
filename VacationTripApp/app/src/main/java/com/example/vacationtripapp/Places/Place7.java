...
import com.example.vacationtripapp.GoogleMaps.map7;
import com.example.vacationtripapp.R;
import com.example.vacationtripapp.Tours.Tourp3;

public class Place7 extends AppCompatActivity {
    ...
    public void gmap(View view){
        startActivity(new Intent(getApplicationContext(), map7.class));
    }
